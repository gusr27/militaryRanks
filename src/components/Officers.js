      ...
      <Grid >
            ...
            <Row style={{paddingTop:10}}>
                ...
                <Col>
                    <View style={{alignItems:"center"}}>
                    <TouchableWithoutFeedback onPress= {() => {Actions.info({title: enlistedData[1].title, data: enlistedData[1]}) }}>
                     <Image source={Images.AF[1].ranks[2]} resizeMode={"contain"}style={{height: 100, width: 100}}
            ...
            <Row>
                ...
                <Col>
                    <View style={{alignItems:"center"}}>
                    <TouchableWithoutFeedback>
                         <Image source={Images.AF[1].ranks[5]} resizeMode={"contain"} style={{height: 100, width: 100}}
            ...
            <Row>
                ...
                <Col>
                    <View style={{alignItems:"center"}}>
                     <TouchableWithoutFeedback>
                    <Image source={Images.AF[1].ranks[6]} resizeMode={"contain"} style={{height: 100, width: 100}}></Image>
                    </TouchableWithoutFeedback>
                    </View>
                </Col>
                <Col>
                    <View style={{alignItems:"center"}}>
                    <TouchableWithoutFeedback>
                         <Image source={Images.AF[1].ranks[7]} resizeMode={"contain"} style={{height: 100, width: 100}}
                ...
                <Col>
                    <View style={{alignItems:"center"}}>
                    <TouchableWithoutFeedback>
                         <Image source={Images.AF[1].ranks[8]} resizeMode={"contain"} style={{height: 100, width: 100}}
            ...
            <Row>
                ...
                <Col>
                    <View style={{alignItems:"center"}}>
                     <TouchableWithoutFeedback>
                    <Image source={Images.AF[1].ranks[9]} resizeMode={"contain"} style={{height: 100, width: 100}}></Image>
                    </TouchableWithoutFeedback>
                    </View>
                </Col>
